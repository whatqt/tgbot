import asyncpg 
from send_mess_by_time.connect import create_connection
...
# asyncio.run(delete_date_time(1483679593))    
# asyncio.run(delete_date_time(1151))    
# asyncio.run(delete_date_time(1752086646))    
...
# asyncio.run(insert_into_time(1752086646, '1008', '18', '18'))
